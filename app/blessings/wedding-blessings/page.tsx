...
export const metadata: Metadata = {
  title: 'Wedding Blessings 2026 | Prayers and Blessings',
  description: 'Beautiful Wedding Blessings for every occasion. Curated prayers and blessings to share divine love and favor.',
  alternates: { canonical: 'https://prayersandblessings.net/blessings/wedding-blessings' },
};
      ...
      <section style={{ background: 'linear-gradient(160deg, #FAF7F2 60%, #FFF5E6 100%)', padding: '4rem 1.5rem 3rem', borderBottom: '1px solid rgba(201,169,110,0.12)' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 400, color: '#1F1F1F', marginBottom: '1rem' }}>
            Wedding Blessings: Prayers and Blessings for the Heart
          </h1>
          <p style={{ fontFamily: 'Manrope, sans-serif', fontSize: '1rem', color: '#6B6B6B', lineHeight: 1.75 }}>
            Curated Wedding Blessings carrying the warmth of divine love for every occasion and season.
          </p>
        </div>
      </section>
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '3rem 1.5rem' }}>
        <AdSlot id="ad-wedding-blessings-top" />
        <div className="prose-spiritual">
          <p style={{ fontFamily: 'Manrope, sans-serif', fontSize: '1.05rem', color: '#3A3A3A', lineHeight: 1.85, marginBottom: '2rem' }}>
            Wedding Blessings carry a sacred tradition of speaking divine goodness over people and occasions. These carefully curated prayers and blessings are written to honor that tradition with beauty, sincerity, and spiritual depth.
          </p>
          <h2 style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: '1.8rem', fontWeight: 500, color: '#1F1F1F', marginBottom: '1rem', paddingBottom: '0.5rem', borderBottom: '1px solid rgba(201,169,110,0.2)' }}>
            A Heartfelt Wedding Blessings Blessing
          </h2>
          ...
          <AdSlot id="ad-wedding-blessings-mid" />
        ...
        <AdSlot id="ad-wedding-blessings-bottom" />
      </div>
    </div>
  );
}
