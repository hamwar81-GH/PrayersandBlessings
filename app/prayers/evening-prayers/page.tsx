...
export const metadata: Metadata = {
  title: 'Evening Prayers 2026 | Prayers and Blessings',
  description: 'Heartfelt Evening Prayers for comfort, peace, and spiritual strength. Curated prayers and blessings for every heart seeking healing.',
  alternates: { canonical: 'https://prayersandblessings.net/prayers/evening-prayers' },
};
      ...
      <section style={{ background: 'linear-gradient(160deg, #FAF7F2 60%, #F5F0FF 100%)', padding: '4rem 1.5rem 3rem', borderBottom: '1px solid rgba(201,169,110,0.12)' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 400, color: '#1F1F1F', marginBottom: '1rem' }}>
            Evening Prayers: Prayers and Blessings for the Soul
          </h1>
          <p style={{ fontFamily: 'Manrope, sans-serif', fontSize: '1rem', color: '#6B6B6B', lineHeight: 1.75 }}>
            A curated collection of Evening Prayers for comfort, spiritual guidance, and divine peace.
          </p>
        </div>
      </section>
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '3rem 1.5rem' }}>
        <AdSlot id="ad-evening-prayers-top" />
        <div className="prose-spiritual">
          ...
          <AdSlot id="ad-evening-prayers-mid" />
        ...
        <AdSlot id="ad-evening-prayers-bottom" />
      </div>
    </div>
  );
}
