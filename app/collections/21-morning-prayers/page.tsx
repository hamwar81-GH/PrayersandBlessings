...
export const metadata: Metadata = {
  title: '21 Morning Prayers Collection 2026 | Prayers and Blessings',
  description: 'Explore our 21 Morning Prayers collection of heartfelt prayers and blessings curated for spiritual depth.',
  alternates: { canonical: 'https://prayersandblessings.net/collections/21-morning-prayers' },
};
  ...
  return (
    <div style={{ minHeight: '100vh' }}>
      <section style={{ background: 'linear-gradient(160deg, #FAF7F2 60%, #EFF6EE 100%)', padding: '4rem 1.5rem 3rem', borderBottom: '1px solid rgba(201,169,110,0.12)' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 400, color: '#1F1F1F', marginBottom: '1rem' }}>
            21 Morning Prayers: A Complete Prayer and Blessing Collection
          </h1>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '3rem 1.5rem' }}>
        <AdSlot id="ad-21-morning-prayers-top" />
        <div className="prose-spiritual">
          ...
          <AdSlot id="ad-21-morning-prayers-mid" />
        ...
        <AdSlot id="ad-21-morning-prayers-bottom" />
      </div>
    </div>
  );
}
