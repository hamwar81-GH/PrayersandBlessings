...
export const metadata: Metadata = {
  title: 'Prayers Difficult Times Collection 2026 | Prayers and Blessings',
  description: 'Explore our Prayers Difficult Times collection of heartfelt prayers and blessings curated for spiritual depth.',
  alternates: { canonical: 'https://prayersandblessings.net/collections/prayers-difficult-times' },
};
  ...
  return (
    <div style={{ minHeight: '100vh' }}>
      <section style={{ background: 'linear-gradient(160deg, #FAF7F2 60%, #EFF6EE 100%)', padding: '4rem 1.5rem 3rem', borderBottom: '1px solid rgba(201,169,110,0.12)' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          <nav style={{ fontFamily: 'Manrope, sans-serif', fontSize: '0.8rem', color: '#9B9B9B', marginBottom: '1.5rem' }}>
            ...
            <span style={{ margin: '0 0.5rem' }}>›</span>
            <span>Prayers Difficult Times</span>
          </nav>
          <h1 style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 400, color: '#1F1F1F', marginBottom: '1rem' }}>
            Prayers Difficult Times: A Complete Prayer and Blessing Collection
          </h1>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '3rem 1.5rem' }}>
        <AdSlot id="ad-prayers-difficult-times-top" />
        <div className="prose-spiritual">
          ...
          <AdSlot id="ad-prayers-difficult-times-mid" />
        ...
        <AdSlot id="ad-prayers-difficult-times-bottom" />
      </div>
    </div>
  );
}
