...
export const metadata: Metadata = {
  title: 'Bedtime Blessings Collection 2026 | Prayers and Blessings',
  description: 'Explore our Bedtime Blessings collection of heartfelt prayers and blessings curated for spiritual depth.',
  alternates: { canonical: 'https://prayersandblessings.net/collections/bedtime-blessings' },
};
      ...
      <section style={{ background: 'linear-gradient(160deg, #FAF7F2 60%, #EFF6EE 100%)', padding: '4rem 1.5rem 3rem', borderBottom: '1px solid rgba(201,169,110,0.12)' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 400, color: '#1F1F1F', marginBottom: '1rem' }}>
            Bedtime Blessings: A Complete Prayer and Blessing Collection
          </h1>
